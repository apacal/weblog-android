...
public class Log {
    ...
    public static void printDebugStack(String tag, final String format, final Object... obj) {
        if (logImp != null && logImp.getLogLevel() <= LEVEL_DEBUG) {
            String log = obj == null ? format : String.format(format, obj);
            if (log == null) {
                log = "";
    ...
    public static void printInfoStack(String tag, final String format, final Object... obj) {
        if (logImp != null && logImp.getLogLevel() <= LEVEL_INFO) {
            String log = obj == null ? format : String.format(format, obj);
            if (log == null) {
                log = "";
